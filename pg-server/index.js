...
app.listen(PORT, () => {
  ...
  console.log('  GET /api/v3/fixed-nodes')
  console.log('  GET /api/v3/buildings')
  console.log('  GET /api/v3/buildings/search')
  console.log('  GET /api/v3/buildings/:buildingName/nearest-nodes')
  console.log('  GET /api/v3/buildings/:buildingName/access-points')
