...
当前版本适合本地比赛演示。核心业务闭环已经完成；正式上线前仍需补充身份鉴权、自动化页面测试和生产部署。
...
2026-08-13 最近一次本地验证：上述 11 项后端测试全部通过，前端构建通过。详细记录见 [docs](./docs/)。

## 当前未完成项

- 统一的一键测试命令与前端端到端自动化测试。
- 登录、身份认证和接口级角色权限。
- 师生端确认取件/取件码闭环。
- Ollama 或百炼真实模型环境验证。
- nginx/进程守护等生产部署配置。
